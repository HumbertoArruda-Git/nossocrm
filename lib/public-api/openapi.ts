      ...
      schemas: {
        ...
        Deal: {
          ...
          properties: {
            ...
            custom_fields: { type: 'object', additionalProperties: {} },
          },
          required: ['id', 'title', 'value', 'board_id', 'stage_id', 'contact_id', 'client_company_id', 'is_won', 'is_lost', 'loss_reason', 'closed_at', 'created_at', 'updated_at', 'custom_fields'],
        },
        DealCustomFields: {
          type: 'object',
          additionalProperties: { oneOf: [{ type: 'string' }, { type: 'number' }, { type: 'boolean' }, { type: 'null' }] },
          description: 'Campos personalizados definidos para Deals na organização.',
        },
        Activity: {
          type: 'object',
          additionalProperties: false,
      ...
      '/deals': {
        get: {
          ...
          parameters: [
            ...
            { name: 'custom_field_key', in: 'query', schema: { type: 'string' }, description: 'Chave de campo personalizado válida para Deals.' },
            { name: 'custom_field_value', in: 'query', schema: { type: 'string' }, description: 'Valor exato do campo personalizado.' },
            { name: 'limit', in: 'query', schema: { type: 'integer', minimum: 1, maximum: 250 } },
            { name: 'cursor', in: 'query', schema: { type: 'string' } },
          ],
          responses: {
